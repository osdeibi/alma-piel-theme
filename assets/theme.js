...
document.addEventListener("DOMContentLoaded", function () {
  ...
  sections.register("collection-template-almapiel", theme.Filters);
...
$(".float").on("mouseover", function () {
  $(".a-cta").removeClass("hide");
  $("#icon-cta2").removeClass("hide");
  $("#icon-cta").addClass("hide-cta-fa");
});

$(".float").on("mouseleave", function () {
  $(".a-cta").addClass("hide");
  $("#icon-cta2").addClass("hide");
  $("#icon-cta").removeClass("hide-cta-fa");
});
